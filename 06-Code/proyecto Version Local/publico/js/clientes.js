document.getElementById('nuevoBtn').addEventListener('click', function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    formCliente.addEventListener('submit', function(event) {
        ...
        fetch('http://localhost:3000/madecor/clientes', {
            method: 'POST',
            headers: {
...
function obtenerClientes(query = '') {
    fetch(`http://localhost:3000/madecor/clientes?q=${query}`)
        .then(response => response.json())
        .then(data => {
    ...
    fetch(`http://localhost:3000/madecor/clientes/${cedula}`)
        .then(response => {
    ...
    window.cambiarEstadoCliente = function (cedula, estadoActual) {
        ...
        fetch(`http://localhost:3000/madecor/clientes/${cedula}/estado`, {
            method: 'PATCH',
