...
<div class="login-icon">
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        echo ' <a href="php/logout.php" title="Cerrar sesión"><i class="fa fa-sign-out" aria-hidden="true"></i></a>';
    } else {
        echo '<a href="../admin/php/login.php" title="Login"><i class="fa fa-sign-in" aria-hidden="true"></i></a>';
        echo ' | <a href="../user/php/customer_registration.php" title="Registrarse">Registrarse</a>';
    }
    ?>
</div>
...
<div class="logout-container">
    <?php if (isset($_SESSION['usuario'])): ?>
        <a href="../user/php/logout.php" class="logout-button">Cerrar sesión</a>
    <?php endif; ?>
</div>
...
<div class="container">
        ...
        <main class="content">
            <section id="home">
				...
				<img src="img/IMG_9549.jpg" alt="Niños jugando con juguetes educativos" style="width: 40%; height: auto; border-radius: 10px; margin-bottom: 20px; display: block; margin-left: auto; margin-right: auto;">
