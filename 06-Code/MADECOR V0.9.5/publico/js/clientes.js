  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    formCliente.addEventListener('submit', function(event) {
        ...
        // La cédula será el nombre de usuario y la contraseña será generada
         ...
         const contrasenaGenerada = CryptoJS.SHA256(cedula).toString(); // Cédula como contraseña
        ...
        const clienteData = {
            ...
            usuario_contrasena: contrasenaGenerada, // Contraseña generada a partir de la cédula
        ...
        fetch('http://localhost:3015/madecor/clientes', {
            method: 'POST',
            headers: {
...
function obtenerClientes(query = '') {
    fetch(`http://localhost:3015/madecor/clientes?q=${query}`)
        .then(response => response.json())
        .then(data => {
    ...
    fetch(`http://localhost:3015/madecor/clientes/${cedula}`)
        .then(response => {
    ...
    window.cambiarEstadoCliente = function (cedula, estadoActual) {
        ...
        fetch(`http://localhost:3015/madecor/clientes/${cedula}/estado`, {
            method: 'PATCH',
