document.getElementById('nuevoBtn').addEventListener('click', function () {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('http://localhost:3015/madecor/permisos')
...
cargarPermisos('trabajadorPermiso'); // Para creación
    ...
    formTrabajador.addEventListener('submit', function(event) {
        ...
        const contrasenaEncriptada = CryptoJS.SHA256(contrasena).toString();
        ...
        const trabajadorData = {
            ...
            usuario_contrasena: contrasenaEncriptada,
        ...
        fetch('http://localhost:3015/madecor/trabajadores', {
            method: 'POST',
            headers: {
    ...
    function obtenerTrabajadores(query = '') {
        fetch(`http://localhost:3015/madecor/trabajadores?q=${query}`) // Pasar el parámetro q
            .then(response => response.json())
            .then(data => {
...
window.editarTrabajador = function (cedula) {
    ...
    fetch(`http://localhost:3015/madecor/trabajadores/${cedula}`)
        .then(response => {
...
window.cambiarEstadoTrabajador = function (cedula, estadoActual) {
    ...
    fetch(`http://localhost:3015/madecor/trabajadores/${cedula}/estado`, {
        method: 'PATCH',
