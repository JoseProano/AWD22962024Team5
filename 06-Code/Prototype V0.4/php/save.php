...
function registrar_cambio($usuario_nombre, $descripcion, $tipo_cambio, $tabla_afectada, $conn) {
...
switch ($tipo) {
    case 'perfil':
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
                registrar_cambio($usuario_nombre, "Perfil agregado: $nombre $apellido", 'Agregar', 'perfiles', $conn);
    ...
    case 'cliente':
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
                registrar_cambio($usuario_nombre, "Cliente agregado: $nombre $apellido", 'Agregar', 'clientes', $conn);
    ...
    case 'proveedor':
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
			 ...
			 if (mysqli_query($conn, $sql)) {
                registrar_cambio($usuario_nombre, "Proveedor agregado: $nombre", 'Agregar', 'proveedores', $conn);
                echo json_encode(['status' => 'success', 'message' => 'Proveedor guardado con éxito']);
            } else {
                echo json_encode(['status' => 'error', 'message' => 'Error al guardar el proveedor: ' . mysqli_error($conn)]);
            }
    ...
    case 'producto':
        ...
        if (mysqli_num_rows($result_check) > 0) {
            ...
            if (mysqli_query($conn, $sql)) {
                registrar_cambio($usuario_nombre, "Producto agregado: $nombre", 'Agregar', 'productos', $conn);
    ...
    case 'servicio':
		...
		if (mysqli_query($conn, $sql)) {
            registrar_cambio($usuario_nombre, "Servicio agregado: $nombre_servicio", 'Agregar', 'servicios', $conn);
   ...
   if (mysqli_query($conn, $sql)) {
            registrar_cambio($usuario_nombre, "Venta realizada para cliente: $cliente", 'Agregar', 'ventas', $conn);
