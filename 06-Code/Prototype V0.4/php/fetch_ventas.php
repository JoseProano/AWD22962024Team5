...
$cedula = isset($_GET['cedula_cliente']) ? $_GET['cedula_cliente'] : ''; // Obtener la cédula del parámetro de consulta

// Consulta para ventas, filtrada por cédula si se proporciona
