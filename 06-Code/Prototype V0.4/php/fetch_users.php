...
// Obtener el tipo de dato a mostrar (perfiles, clientes, proveedores, productos, servicios o ventas)
...
switch ($tipo) {
    case 'perfiles':
        ...
        $headers = ['ID', 'Nombre', 'Apellido', 'Email', 'Género', 'Fecha de Nacimiento', 'Cédula', 'Usuario', 'Perfil', 'Estado', 'Acciones'];
        break;
    ...
    case 'clientes':
        ...
        $headers = ['ID', 'Nombre', 'Apellido', 'Email', 'Género', 'Fecha de Nacimiento', 'Cédula', 'Número', 'Locación', 'Estado', 'Acciones'];
        break;
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        switch ($tipo) {
            ...
            case 'servicios':
                ...
                echo '<td>' . htmlspecialchars($row['costo_servicio']) . '</td>';
                echo '<td>' . htmlspecialchars($row['coste_total']) . '</td>';
                echo '<td>' . htmlspecialchars($row['estado']) . '</td>';
                break;
